...
//        //        let loginRequest = LoginRequest(email: email, password: passsword, fcm_key: "gdsgdsbs", device: "iOS" , login_type: "client")
//        let loginRequest = LoginRequest(email: email, password: passsword, fcm_key: "gdsgdsbs", device: "iOS" , login_type: "client")
//        let loginValidation = LoginValidation()
//        let validationResult = loginValidation.validate(request: loginRequest)
//        if validationResult.success{
...
//                Database.database().reference().child("users").child("\((response.data?.userID)!)").updateChildValues(userDict as [AnyHashable : Any])
